...
import com.looksee.auditManager.models.Account;
import com.looksee.auditManager.models.AuditRecord;
import com.looksee.auditManager.models.Domain;
import com.looksee.auditManager.models.PageAuditRecord;
import com.looksee.auditManager.models.repository.AccountRepository;
...
public class AccountService {
	...
	public Account addAuditRecord(long account_id, long audit_record_id) {
		return account_repo.addAuditRecord(account_id, audit_record_id);
	}
